    ...
    <div class="col-12">
        <div class="card h__card shadow">
            <div class="card-header text-center bg-transparent">
                <h3 class="card-title m-0">Wij werken in Nederland + grensgebied</h3>
                <h5 class="m-0 mt-4 text-success">BETALING IN 3 TERMIJNEN IS MOGELIJK!</h5>
                <p class="text-success m-0">Vraag naar de voorwaarden</p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <div class="row">
                                ...
                                <small>Hoe heeft u ons gevonden?</small>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
