<div class="table-header d-flex justify-content-between mb-3">
    ...
    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addBTWModal"><?php echo esc_html('Add New', 'house-configurator'); ?></button>
</div>
<table class="table table-hover house_configurator_table">
    <thead>
        <tr>
            <th><?php echo esc_html('ID', 'house-configurator'); ?></th>
            <th><?php echo esc_html('BTW Name', 'house-configurator'); ?></th>
            <th><?php echo esc_html('BTW Price', 'house-configurator'); ?></th>
        ...
        foreach ($btw_list as $key => $value) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo admin_url('admin.php?page=house_config_house_part_two&delet_b_t_w=' . $value['name']); ?>" class="button button-primary"><?php echo esc_html('Delete', 'house-configurator'); ?></a>
                </td>
            </tr>
            <?php
        }
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="addBTWModalLabel"><?php echo esc_html('Add New BTW', 'house-configurator'); ?></h5>
				...
				<div class="modal-body">
					<form action="<?php echo esc_attr('admin-post.php'); ?>" method="post">
						...
						<div class="form-group">
							<label for="btw_name"><?php echo esc_html('BTW Name', 'house-configurator'); ?></label>
							<input type="text" name="btw_name" id="btw_name" class="form-control" placeholder="Enter text">
						</div>
						<div class="form-group">
							<label for="btw_price"><?php echo esc_html('BTW Price', 'house-configurator'); ?></label>
        ...
        <form action="<?php echo esc_attr('admin-post.php'); ?>" method="post">
            ...
            <table class="form-table">
                <tr class="example-class">
                    <th scope="row"><?php echo esc_html('BTW Name', 'house-configurator'); ?></th>
                    <td><input type="text" name="btw_name" value="<?php echo $selected_btw['name']; ?>" class="regular-text" /></td>
                </tr>
                <tr class="example-class">
                    <th scope="row"><?php echo esc_html('BTW Price', 'house-configurator'); ?></th>
